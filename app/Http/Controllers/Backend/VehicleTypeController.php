...
class VehicleTypeController extends Controller
{
    ...
    public $index = "backend/vehicle_type/index";
    public $create = "backend/vehicle_type/create";
    public $store = "backend/vehicle_type/store";
    public $show = "backend/vehicle_type_detail/index";
    public $edit = "backend/vehicle_type/edit";
    public $update = "backend/vehicle_type/update";
    public $destroy = "backend/vehicle_type/destroy";

    public $file_storage = "public/img/vehicle_type";
    ...
    public function index()
    {
        ...
        $data['table_data'] = VehicleTypeModel::all();
    ...
    public function edit($id)
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "edit_vehicle_type"=>array(
                "text"=>"Edit Vehicle Type", 
                "link"=>"", 
                "is_active"=>"active"
            )            
        );
        ...
        $data['table_content'] = VehicleTypeModel::find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $update = VehicleTypeModel::find($id);
        for ($i=0; $i < $count; $i++) { 
            $text_type = $arr_field_type[$i];
            $text_check = substr($text_type,0,3);
            if ($text_check == "cha") {
    ...
    {
        $findtodelete = VehicleTypeModel::find($id);
        $findtodelete->delete();
