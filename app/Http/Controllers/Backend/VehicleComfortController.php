...
class VehicleComfortController extends Controller
{
    /**
    ...
    */
    ...
    public function create()
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "vehicle_comfort"=>array(
                "text"=>"Vehicle Comfort", 
                "link"=>"backend/vehicle_comfort/index",
                "is_active"=>"inactive"
            ),
            "create_vehicle_comfort"=>array(
                "text"=>"Create Vehicle Comfort", 
                "link"=>"", 
                "is_active"=>"active"
            )                        
        );
    ...
    public function edit($id)
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "edit_vehicle_comfort"=>array(
                "text"=>"Edit Vehicle Comfort", 
                "link"=>"", 
                "is_active"=>"active"
            )                        
        );
