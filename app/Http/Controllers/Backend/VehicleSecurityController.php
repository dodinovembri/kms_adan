...
class VehicleSecurityController extends Controller
{
     ...
     */
    public $table = "vehicle_security";

    public $index = "backend/vehicle_security/index";
    public $create = "backend/vehicle_security/create";
    public $store = "backend/vehicle_security/store";
    public $show = "backend/vehicle_security/show";
    public $edit = "backend/vehicle_security/edit";
    public $update = "backend/vehicle_security/update";
    public $destroy = "backend/vehicle_security/destroy";

    public $file_storage = "public/img/vehicle_security";
    ...
    {        
        ...
        $data['breadcrumb'] = array(
            ...
            "vehicle_security"=>array(
                "text"=>"Vehicle Security", 
                "link"=>"", 
                "is_active"=>"active"
            )            
        );
        $data['title'] = "Vehicle Security";
        ...
        $data['table_data'] = VehicleSecurityModel::where('vehicle_id', $vehicle_id)->get();
    ...
    public function create()
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "vehicle_security"=>array(
                "text"=>"Vehicle Security", 
                "link"=>"backend/vehicle_security/index",
                "is_active"=>"inactive"
            ),
            "create_vehicle_security"=>array(
                "text"=>"Create Vehicle Security", 
                "link"=>"", 
                "is_active"=>"active"
            )                        
        );
        $data['title'] = "Create Vehicle Security";
    ...
    public function store(Request $request)
    {
        ...
        $insert = new VehicleSecurityModel();
        for ($i=0; $i < $count; $i++) { 
    ...
    public function edit($id)
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "edit_vehicle_security"=>array(
                "text"=>"Edit Vehicle Security", 
                "link"=>"", 
                "is_active"=>"active"
            )                        
        );
        $data['title'] = "Edit Vehicle Security";
        ...
        $data['table_content'] = VehicleSecurityModel::find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $update = VehicleSecurityModel::find($id);
        for ($i=0; $i < $count; $i++) { 
            $text_type = $arr_field_type[$i];
            $text_check = substr($text_type,0,3);
            if ($text_check == "cha") {
    ...
    {
        $findtodelete = VehicleSecurityModel::find($id);
        $findtodelete->delete();
