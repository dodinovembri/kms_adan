...
class FuelTypeController extends Controller
{
    ...
    public $index = "backend/fuel_type/index";
    public $create = "backend/fuel_type/create";
    public $store = "backend/fuel_type/store";
    public $show = "backend/fuel_type_detail/index";
    public $edit = "backend/fuel_type/edit";
    public $update = "backend/fuel_type/update";
    public $destroy = "backend/fuel_type/destroy";

    public $file_storage = "public/img/fuel_type";
    ...
    public function index()
    {
        ...
        $data['table_data'] = FuelTypeModel::all();
    ...
    public function create()
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "create_fuel_type"=>array(
                "text"=>"Create Fuel Type", 
                "link"=>"#", 
                "is_active"=>"active"
            )
        );
        $data['title'] = "Create Fuel Type";
    ...
    public function edit($id)
    {
        ...
        $data['table_content'] = FuelTypeModel::find($id);
    ...
    {
        $findtodelete = FuelTypeModel::find($id);
        $findtodelete->delete();
