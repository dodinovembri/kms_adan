...
class VehiclePassiveSafetyController extends Controller
{
    /**
     ...
     */
    public $table = "vehicle_passive_safety";

    public $index = "backend/vehicle_passive_safety/index";
    public $create = "backend/vehicle_passive_safety/create";
    public $store = "backend/vehicle_passive_safety/store";
    public $show = "backend/vehicle_passive_safety/show";
    public $edit = "backend/vehicle_passive_safety/edit";
    public $update = "backend/vehicle_passive_safety/update";
    public $destroy = "backend/vehicle_passive_safety/destroy";

    public $file_storage = "public/img/vehicle_passive_safety";
    ...
    {        
        ...
        $data['breadcrumb'] = array(
            ...
            "vehicle_passive_safety"=>array(
                "text"=>"Vehicle Passive Safety", 
                "link"=>"", 
                "is_active"=>"active"
            )            
        );
        $data['title'] = "Vehicle Passive Safety";
        ...
        $data['table_data'] = VehiclePassiveSafetyModel::where('vehicle_id', $vehicle_id)->get();
    ...
    public function create()
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "vehicle_passive_safety"=>array(
                "text"=>"Vehicle Passive Safety", 
                "link"=>"backend/vehicle_passive_safety/index",
                "is_active"=>"inactive"
            ),
            "create_vehicle_passive_safety"=>array(
                "text"=>"Create Vehicle Passive Safety", 
                "link"=>"", 
                "is_active"=>"active"
            )                        
        );
        $data['title'] = "Create Vehicle Passive Safety";
    ...
    public function store(Request $request)
    {
        ...
        $insert = new VehiclePassiveSafetyModel();
        for ($i=0; $i < $count; $i++) { 
    ...
    public function edit($id)
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "edit_vehicle_passive_safety"=>array(
                "text"=>"Edit Vehicle Passive Safety", 
                "link"=>"", 
                "is_active"=>"active"
            )                        
        );
        $data['title'] = "Edit Vehicle Passive Safety";
        ...
        $data['table_content'] = VehiclePassiveSafetyModel::find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $update = VehiclePassiveSafetyModel::find($id);
        for ($i=0; $i < $count; $i++) { 
            $text_type = $arr_field_type[$i];
            $text_check = substr($text_type,0,3);
            if ($text_check == "cha") {
    ...
    {
        $findtodelete = VehiclePassiveSafetyModel::find($id);
        $findtodelete->delete();
