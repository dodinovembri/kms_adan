...
<html>
	<head>
		...
		<title>Single Product Left Sidebar | Porto - Responsive HTML5 Template 7.6.0</title>	
					...
					<div class="row">
						...
						<div class="col-lg-9">
							...
							<div class="container">
								...
								<div class="row">
									<div class="col">
										<h4 class="mb-2">Tutorial Pengechekan Oli Mesin</h4>
										...
										<div class="process process-vertical py-4">
											...
											<div class="process-step appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
												...
												<div class="process-step-content">
													...
													<p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas risus est, dignissim non urna at, efficitur cursus nibh. Curabitur varius vel mauris at auctor. Nam ullamcorper bibendum est et porta. Donec congue libero vitae semper varius. Vivamus eu congue leo. Quisque ullamcorper elit at <img class="float-left" width="150" height="106" src="img/device.png" alt="">metus elementum condimentum. Sed orci augue, pellentesque in egestas quis, vestibulum non ex. Suspendisse tempus tellus ac augue iaculis suscipit.</p>
												</div>
											</div>
