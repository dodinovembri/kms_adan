						...
						<div class="tabs tabs-vertical tabs-left">
							...
							<div class="tab-content">
								...
								<div id="vehicle_engine" class="tab-pane">
									<div class="card-body">
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Engine Cilinder</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_engine->vehicle_engine_cilinder }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Driver Type</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_engine->driver->driver_type_name }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Engine Configuration</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_engine->engine_configuration }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Fuel Tank Maximum</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_engine->fuel_tank_maxium }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Fuel Type</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_engine->fuel->fuel_type_name }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Total Cilinder</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_engine->total_cilinder }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Transimisi Configuration</label>
											<div class="col-lg-10">
								...
								<div id="vehicle_performance" class="tab-pane">
									<div class="card-body">
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Power</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_performance->vehicle_power }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Torsion</label>
											<div class="col-lg-10">
								...
								<div id="vehicle_suspention" class="tab-pane">
									<div class="card-body">
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Front Brake</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_suspention->front_brake }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Front Suspention</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_suspention->front_suspention }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Rear Brake</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_suspention->rear_brake }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Rear Suspention</label>
											<div class="col-lg-10">
								...
								<div id="vehicle_velg_tire" class="tab-pane">
									<div class="card-body">
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Tire Size</label>
											<div class="col-lg-10">
												<input type="text" name="" value="{{ $vehicle_velg_tire->tire_size }}" class="form-control" >
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Velg Material</label>
											<div class="col-lg-10">
								...
								<div id="vehicle_passive_safety" class="tab-pane">
									<div class="card-body">
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Airbag System</label>
											<div class="col-lg-10">
								...
								<div id="vehicle_communication" class="tab-pane">
									<div class="card-body">
										<div class="form-group row">
											<label class="col-lg-2 control-label text-lg-right pt-2">Audio</label>
											<div class="col-lg-10">
